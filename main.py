...
st.write("Bienvenida al despliegue interactivo en Hugging Face Spaces. Selecciona una simulación para validar los componentes:")
...
with tab1:
    ...
    st.text_input("Introduce el Ticker del Activo:", "FSM", key="ticker_hf")
...
with tab2:
    ...
    if st.button("Validar Conexión PostgreSQL"):
        ...
        st.json({
            ...
            "detail": "El motor relacional externo no se encuentra accesible de forma directa en Hugging Face. Simulación completada."
        })
